                        ...
                        <div class="job-card reveal reveal-d<?= ($i % 2) + 1 ?> group">
                            ...
                            <div class="p-5">
                                ...
                                <div class="flex items-center gap-2 pt-4 border-t border-gray-100 dark:border-gray-700/50">
                                    ...
                                    <?php else: ?>
                                        <a href="<?= e(base_url('auth/login.php')) ?>" class="flex-1 inline-flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-600 hover:to-accent-600 shadow-md shadow-primary-500/20 hover:shadow-lg hover:-translate-y-0.5 transition-all" onclick="event.stopPropagation()">
                                            <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-4">
                ...
                $steps = [
                    ...
                    ['num' => '02', 'title' => 'Build Profile', 'desc' => 'Showcase your skills and experience', 'icon' => '<path stroke-linecap="round" stroke-linejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>', 'color' => 'from-purple-500 to-accent-600'],
            ...
            <div class="cta-glow relative overflow-hidden rounded-3xl bg-gradient-to-r from-primary-600 via-accent-600 to-primary-700 p-12 md:p-16 lg:p-20 text-center reveal">
                ...
                <div class="relative z-10">
                    ...
                    <div class="flex flex-wrap justify-center gap-4">
                        <a href="<?= e(base_url('auth/register.php')) ?>" class="inline-flex items-center px-8 py-4 rounded-xl font-bold text-primary-600 bg-white hover:bg-gray-50 transition-all shadow-xl shadow-black/10 hover:shadow-2xl hover:-translate-y-1">
