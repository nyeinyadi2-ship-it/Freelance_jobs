...
<div class="glass rounded-2xl p-6 mb-6 hover-lift reveal">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div class="flex items-center gap-4">
            ...
            <div><h1 class="text-xl font-bold" style="color:var(--color-text-primary)"><?= e($fl_profile['full_name'] ?? $fl_profile['username']) ?></h1><?php if ($fl_profile['title']): ?><p class="text-sm font-medium text-primary-600"><?= e($fl_profile['title']) ?></p><?php endif; ?><p class="text-xs" style="color:var(--color-text-placeholder)">Joined <?= date('M Y', strtotime($fl_profile['created_at'])) ?></p></div>
        </div>
    ...
    <div class="grid md:grid-cols-2 gap-6">
        ...
        <div class="glass rounded-2xl p-6 hover-lift reveal reveal-d1">
            ...
            <dl class="space-y-3 text-sm">
                ...
                <?php if ($fl_profile['portfolio_url']): ?><div class="flex justify-between"><dt style="color:var(--color-text-muted)">Portfolio</dt><dd class="font-semibold"><a href="<?= e($fl_profile['portfolio_url']) ?>" target="_blank" class="text-primary-600 hover:underline text-xs">View Portfolio &rarr;</a></dd></div><?php endif; ?>
