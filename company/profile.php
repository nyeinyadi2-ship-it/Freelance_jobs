...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center justify-between mb-6">
        ...
        <div class="flex gap-2">
            <?php if ($is_edit): ?>
                <a href="javascript:history.back()" class="btn-secondary text-sm">Back</a>
            <?php else: ?>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                <div class="group relative overflow-hidden rounded-2xl p-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg" style="background:var(--color-card);border:1px solid var(--color-border)">
                    ...
                    <div class="relative">
                        ...
                        <p class="text-3xl font-extrabold tracking-tight" style="color:var(--color-text-primary)"><?= number_format($total_paid, 2) ?> MMK</p>
