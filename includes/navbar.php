                ...
                <?php if ($is_logged_in): ?>
                    ...
                    <div class="relative notification-container">
                        <button type="button" class="notification-toggle ni relative" aria-label="<?= e(__('notif.title')) ?>">
                            ...
                            <?php if ($unread_count > 0): ?><span class="absolute top-[2px] right-[2px] nb" style="background:#ef4444;border-color:#fff"><?= min($unread_count,99) ?></span><?php endif; ?>
                        </button>
...
<div id="mobile-panel" class="mp">
    ...
    <div class="py-2">
        ...
        <?php if ($is_logged_in): ?>
            ...
            <a href="<?= e(base_url('notifications.php')) ?>" class="ml"><svg class="w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>Notifications<?php if ($unread_count > 0): ?><span class="ml-auto text-[10px] font-bold px-1.5 py-0.5 rounded-full text-white" style="background:#ef4444"><?= min($unread_count,99) ?></span><?php endif; ?></a>
