...
<div class="auth-wrapper">
  <div class="auth-card">
    ...
    <div class="text-center mb-8">
      ...
      <p class="mt-3 text-sm" style="color:var(--color-text-muted)"><?= e(__('login.welcome_back')) ?></p>
    </div>
    ...
    <div class="rounded-2xl p-6 sm:p-8" style="background:var(--color-card);border:1px solid var(--color-border);box-shadow:0 4px 24px rgba(0,0,0,0.06);">
      ...
      <form method="POST" class="space-y-5" novalidate>
        ...
        <div class="auth-input-group">
          <label class="block text-sm font-medium mb-1.5" style="color:var(--color-text-secondary)"><?= e(__('login.email')) ?></label>
          <div class="relative">
        ...
        <!-- Password -->
        <div class="auth-input-group">
          <label class="block text-sm font-medium mb-1.5" style="color:var(--color-text-secondary)"><?= e(__('login.password')) ?></label>
          <div class="relative">
        ...
        <div class="flex items-center justify-between">
          ...
          <a href="<?= e(base_url('forgot_password.php')) ?>" class="text-sm font-medium text-indigo-600 hover:text-indigo-500 transition-colors"><?= e(__('login.forgot')) ?></a>
        </div>
      ...
      <div class="mt-6">
        <div class="auth-divider">
          <span><?= e(__('login.or_continue')) ?></span>
        </div>
    ...
    <p class="mt-6 text-center text-sm" style="color:var(--color-text-muted)">
      ...
      <a href="<?= e(base_url('register.php')) ?>" class="font-semibold text-indigo-600 hover:text-indigo-500 transition-colors"><?= e(__('login.register_link')) ?></a>
    </p>
  </div>
</div>
